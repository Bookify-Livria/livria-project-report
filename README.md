...
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | - **Argomedo Camacho, Jhosep Jamil (TB1)**: <br> Desempeñó de manera ejemplar la creación de un entorno colaborativo y en la planificación de tareas dentro del equipo. Su capacidad para coordinar actividades y liderar la estructuración del documento permitió un avance eficiente en las fases iniciales del proyecto. <br> - **Binda Arbañil, Marcelo Alejandro(TB1)**: <br> Desempeñó un papel clave en el desarrollo de un ambiente inclusivo, contribuyendo activamente al análisis de requisitos y la planificación de tareas. Su enfoque en la interacción con los usuarios a través de entrevistas y la creación de User personas fue crucial para comprender las necesidades del proyecto. <br> - **Borja Molina, Gabriel Sebastián(TB1)**: <br> Se encargó de coordinar las tareas relacionadas con el desarrollo de la interfaz y la arquitectura técnica. Su participación activa en la planificación y definición de objetivos garantizó que las tareas se distribuyeran de manera efectiva entre los miembros del equipo, favoreciendo un avance ordenado. <br> - **Castillo Garay, Ainhoa Lucía (TB1)**: <br> Lideró la organización de las tareas dentro del equipo, asegurando que cada miembro tuviera una comprensión clara de sus responsabilidades. Además, promovió una comunicación constante entre los miembros del equipo para asegurar que todas las metas se alcanzaran con éxito y que el entorno fuera inclusivo. <br> - **Sulca Silva, Melisa Geraldine (TB1)**: <br> Se centró en la creación de un ambiente de trabajo inclusivo, donde todos los miembros pudieron expresar sus ideas y contribuir al proyecto. Su trabajo en la recopilación de requisitos y la estructura del Product Backlog fue esencial para mantener una planificación adecuada y asegurar que los objetivos del proyecto fueran cumplidos. | El desarrollo de Livria también resalta la creación de un entorno de trabajo cooperativo y abierto a la participación activa. El profundo trabajo de recopilación y análisis de requisitos, a través de entrevistas, técnicas de needfinding y la elaboración de user personas, evidencia un compromiso genuino por entender a los usuarios y responder a sus necesidades reales. La definición clara de los objetivos del producto y de los segmentos de usuarios objetivo muestra una planificación estratégica sólida. La organización de tareas se ve plasmada en la estructuración del documento, la construcción del Product Backlog y la preparación del primer sprint enfocado en el desarrollo de la landing page. El progreso alcanzado en la fase inicial de implementación reafirma la capacidad del equipo para convertir la planificación en resultados concretos. |
...
**Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | - **Argomedo Camacho, Jhosep Jamil (TP)**: <br> Asumió un rol clave en la planificación del Sprint 2 al definir las tareas críticas relacionadas con la vista de "Comunidades". <br> - **Binda Arbañil, Marcelo Alejandro (TP)**: <br> Se encargó de la implementación de diversas secciones técnicas de la aplicación web, como "Recomendaciones", "Libros", "Comunidades" y "Suscripción". Coordinó con el equipo la asignación de tareas del frontend para asegurar que las funcionalidades fueran implementadas de forma cohesiva. <br> - **Borja Molina, Gabriel Sebastián (TP)**: <br> Asumió la responsabilidad de la implementación técnica de la sección de "Cuenta de Usuario". Su enfoque en la parte técnica permitió a los usuarios tener una experiencia fluida al interactuar con la aplicación. <br> - **Castillo Garay, Ainhoa Lucía (TP)**: <br> Se encargó de la implementación de secciones clave de la aplicación, como "Inicio", "Comunidades", "Carrito de compras", "Órdenes" y "Notificaciones". Coordinó con el equipo para integrar las funcionalidades visuales con las capacidades del backend, asegurando que la interfaz de usuario fuera coherente con la arquitectura general de la aplicación.  <br> - **Sulca Silva, Melisa Geraldine (TP)**: <br> Se encargó de la revisión y resolución de problemas relacionados con el diseño responsivo. También contribuyó a la redacción técnica y la documentación del Sprint 2, ayudando a estructurar las historias de usuario y garantizar que el equipo estuviera alineado con las expectativas del cliente. | **Argomedo Camacho, Jhosep Jamil** <br> Fomentó un ambiente inclusivo durante el Sprint 2, promoviendo la participación activa de todos los miembros del equipo en las decisiones del proyecto, especialmente en las funcionalidades de 'Comunidades'. <br> Contribuyó a la planificación de tareas, asegurando que los objetivos fueran alcanzados en cada sprint. <br> <br> **Binda Arbañil, Marcelo Alejandro** <br> Facilitó la colaboración efectiva al establecer metas claras y distribuir tareas de acuerdo a las fortalezas del equipo durante el Sprint 2, promoviendo el éxito en diferentes funcionalidades. <br> Participó en la creación de un entorno positivo y motivador que impulsó el rendimiento del equipo durante el segundo sprint, asegurando que las secciones principales sean implementadas de manera correcta. <br> <br> **Borja Molina, Gabriel Sebastián** <br> Apoyó a sus compañeros en la planificación y ejecución de tareas del Sprint 2, promoviendo un trabajo colaborativo y eficiente para las funcionalidades principalmente de registro. <br> Contribuyó a la creación de un entorno inclusivo mediante la integración de ideas diversas en el desarrollo del proyecto. <br> <br> **Castillo Garay, Ainhoa Lucía** <br> Facilitó la comunicación entre los miembros del equipo, asegurando que todos comprendieran los objetivos del Sprint 2 para las funcionalidades y secciones principales. <br> Ayudó en la organización de tareas y seguimiento de los avances para cumplir con los plazos establecidos durante el segundo sprint. <br> <br> **Sulca Silva, Melisa Geraldine** <br> Promovió un entorno de colaboración inclusiva al integrar nuevas perspectivas en el diseño de soluciones para las funcionalidades del Sprint 2. <br> Colaboró en la planificación de tareas para garantizar que los objetivos del proyecto fueran alcanzados de manera eficiente. |
...
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | - **Argomedo Camacho, Jhosep Jamil (TB2)**: <br> Colaboró el desarrollo e implementación de la base de datos, gestionando la creación del servidor de base de datos en Azure. Además, implementó y mejoró el dashboard de administrador, asegurando que la interfaz fuera intuitiva y eficiente para la administración del sistema. <br> - **Binda Arbañil, Marcelo Alejandro (TB2)**: <br> Lideró la implementación de los bounded contexts, asegurando que el sistema estuviera bien estructurado y desacoplado. Definió claramente los límites de cada contexto dentro del sistema, facilitando el desarrollo modular y promoviendo un enfoque organizado dentro del equipo. <br> - **Borja Molina, Gabriel Sebastián (TB2)**: <br> Desarrolló un papel crucial en la implementación de los bounded contexts, trabajando en colaboración con Marcelo para garantizar que cada componente del sistema estuviera claramente definido y separado. Su trabajo permitió mejorar la escalabilidad del proyecto y optimizó la gestión de dependencias entre los diferentes módulos. <br> - **Castillo Garay, Ainhoa Lucía (TB2)**: <br> Lideró la corrección y mejora del frontend, trabajando en la integración de nuevas funcionalidades y asegurando que la experiencia del usuario fuera fluida. Además, colaboró activamente con el equipo en la implementación de mejoras de diseño, integrando cambios tanto a nivel funcional como estético en el proyecto. <br> - **Sulca Silva, Melisa Geraldine (TB2)**: <br> Se encargó de la internalización de la interfaz de administrador (Dashboard), asegurando que el sistema fuera accesible para usuarios de diferentes lenguajes. También participó en la redacción del Sprint 3 y en la documentación técnica, organizando la información de manera clara y estructurada para facilitar el seguimiento del proyecto. | **Argomedo Camacho, Jhosep Jamil** <br> Jhosep facilitó un entorno inclusivo, distribuyendo tareas de manera equitativa y asegurando que todos comprendieran los objetivos del proyecto, lo que permitió un desarrollo fluido. <br> <br> **Binda Arbañil, Marcelo Alejandro** <br> Marcelo estableció metas claras y distribuyó tareas según las fortalezas del equipo, lo que permitió avanzar eficazmente en el desarrollo del proyecto y alcanzar los objetivos establecidos. <br> <br> **Borja Molina, Gabriel Sebastián** <br> Gabriel apoyó en la planificación de tareas y promovió un entorno colaborativo, asegurando que los objetivos del proyecto se alcanzaran sin dificultades, con un enfoque inclusivo. <br> <br> **Castillo Garay, Ainhoa Lucía** <br> Ainhoa contribuyó a la organización del trabajo, manteniendo una comunicación constante dentro del equipo y asegurando que todos los objetivos del proyecto fueran cumplidos eficientemente. <br> <br> **Sulca Silva, Melisa Geraldine** <br> Melisa promovió un entorno inclusivo, integrando perspectivas diversas y manteniendo una planificación clara, lo que permitió que el equipo avanzara hacia los objetivos de manera coordinada. |
...
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | - **Argomedo Camacho, Jhosep Jamil (TF)**: <br> Organizó y planificó el Sprint Backlog, ayudando a definir las tareas clave y a organizar el equipo para que todas las actividades estuvieran alineadas con los objetivos. Además, se encargó de coordinar los entregables, asegurando que todos los miembros del equipo tuvieran claridad sobre las historias de usuario y las tareas a realizar. <br> - **Binda Arbañil, Marcelo Alejandro (TF)**: <br> Se encargó de la corrección de errores críticos en el backend durante la fase de planificación del Sprint Backlog. Su enfoque permitió identificar y priorizar los problemas más relevantes, lo que permitió al equipo abordar esos obstáculos desde el principio del sprint y garantizar una base sólida para las siguientes tareas. <br> - **Borja Molina, Gabriel Sebastián (TF)**: <br> Desempeñó un rol clave en la planificación del sistema de autenticación. Fue responsable de establecer las prioridades técnicas y estructurales para implementar la autenticación mediante tokens, asegurando que el equipo pudiera avanzar con claridad en la implementación de seguridad en el proyecto. <br> - **Castillo Garay, Ainhoa Lucía (TF)**: <br> Lideró el proceso de integración del frontend con el backend. Durante la planificación del Sprint Backlog, se encargó de definir las tareas para finalizar el frontend, alineando la interfaz de usuario con los requerimientos técnicos del backend y asegurando que ambos aspectos estuvieran perfectamente integrados en el plan del sprint. <br> - **Sulca Silva, Melisa Geraldine (TF)**: <br> Contribuyó en la creación y documentación del Sprint Backlog, ayudando a definir las tareas pendientes y asegurando que todo el equipo tuviera claro qué se debía priorizar. Su participación en la estructuración del sprint permitió mantener una comunicación clara y eficiente durante todo el proceso. | **Argomedo Camacho, Jhosep Jamil** <br> Jhosep promovió un entorno de trabajo inclusivo y colaborativo, impulsando la planificación de tareas y la coordinación entre los miembros del equipo. Su enfoque organizativo permitió avanzar de forma clara hacia los objetivos del Sprint. <br> <br> **Binda Arbañil, Marcelo Alejandro** <br> Marcelo mostró compromiso al coordinar sus tareas de backend con el resto del equipo, facilitando un entorno de trabajo colaborativo y cumpliendo con los objetivos técnicos en los plazos establecidos. <br> <br> **Borja Molina, Gabriel Sebastián** <br> Gabriel mantuvo una comunicación constante con el equipo, colaborando en la planificación de tareas relacionadas con la autenticación. Su trabajo contribuyó a mantener el ritmo del desarrollo y alcanzar los objetivos técnicos planteados. <br> <br> **Castillo Garay, Ainhoa Lucía** <br> Ainhoa fomentó la colaboración activa, manteniendo alineados los procesos del frontend con los requerimientos del backend. Estableció metas claras y contribuyó significativamente al cumplimiento de los objetivos del proyecto. <br> <br> **Sulca Silva, Melisa Geraldine** <br> Melisa contribuyó a crear un entorno inclusivo durante la redacción del informe, integrando aportes de todos los miembros y asegurando que los objetivos del Sprint fueran documentados y reflejados con claridad. |
...
| Repository | Branch | Commit Id | Commit Message | Commit Message Body | Commited on (Date) |
|---|---|---|---|---|---|
| https://github.com/Bookify-Livria/livria-backend.git | develop | 035aeda | fix: "Fix LIVRIA" | --------- | 07/07/2025 |
| https://github.com/Bookify-Livria/livria-backend.git | develop | 69bb7e0 | feat: "Add LeaveCommunityCommand.cs" | --------- | 07/07/2025 |
| https://github.com/Bookify-Livria/livria-backend.git | develop | cbe4aa6 | feat: "Add GetAllOrdersQuery.cs" | --------- | 07/07/2025 |
| https://github.com/Bookify-Livria/livria-backend.git | develop | e5aa6f5 | feat: "Add Capital in UserAdminResource.cs" | --------- | 06/07/2025 |
...
| https://github.com/Bookify-Livria/livria-web-app.git | feature/additionals | e669983 | feat: Add Books to inventory and update stock based on the admin's capital | --------- | 06/07/2025 |
| https://github.com/Bookify-Livria/livria-web-app.git | feature/additionals | dde77f4 | feat: Cart conection to database | --------- | 06/07/2025 |
| https://github.com/Bookify-Livria/livria-web-app.git | feature/additionals | b5287e0 | feat: Order connection to database | --------- | 07/07/2025 |
...
| https://github.com/Bookify-Livria/livria-web-app.git | develop | e669983 | feat: Add Books to inventory and update stock based on the admin's capital | --------- | 06/07/2025 |
...
* Historial de commits:
  ...
  <p align="center">
  <img src="https://i.imgur.com/RcJspDA.png" alt="rep41" width="500">
  </p>
...
* Historial de commits:
  ...
  <p align="center">
  <img src="https://i.imgur.com/WD1EV1l.png" alt="rep44" width="500">
  </p>
